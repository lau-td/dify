...
from controllers.codelight.web.wraps import create_or_update_end_user_for_user_id
...
class CodelightWebPassportResource(Resource):
    ...
    def post(self):
        ...
        #########################################################
        # Get the email and username from the request body
        #########################################################
...
api.add_resource(CodelightWebPassportResource, "/web/passport")
